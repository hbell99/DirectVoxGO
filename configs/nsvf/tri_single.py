...
expname = '1resconv_newrgb_liif_d_o_Wineholder'
...
data = dict(
    ...
    test_scenes=['Wineholder'] #, 'Lifestyle', 'Palace', 'Robot', 'Spaceship', 'Steamtrain', 'Toad', 'Wineholder']
)
